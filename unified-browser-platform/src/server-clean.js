...
class UnifiedBrowserPlatform {
  ...
  async setupRoutes() {
    // Debug: Check services before creating routes
    ...
    console.log(
      ...
      typeof this.sessionManager.createSession,
    );
    console.log(
      "🔍 sessionManager methods:",
      Object.getOwnPropertyNames(Object.getPrototypeOf(this.sessionManager)),
    );
    ...
    // Debug: Check sessionManager before creating browser-use routes
    console.log("🔍 Before creating browser-use routes:");
    ...
    // Test: Try to call createSession directly
    try {
      console.log("🧪 Testing sessionManager.createSession directly...");
      const testSession = await this.sessionManager.createSession({
        test: true,
      });
      console.log("✅ Direct call successful:", testSession.id);
    } catch (error) {
