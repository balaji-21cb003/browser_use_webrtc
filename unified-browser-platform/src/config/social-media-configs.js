...
export function getRandomDelay(platform, action = 'default') {
  ...
  switch (action) {
    case 'click':
      return Math.random() * (timing.clickDelay.max - timing.clickDelay.min) + timing.clickDelay.min;
    case 'scroll':
      return Math.random() * (timing.scrollSpeed.max - timing.scrollSpeed.min) + timing.scrollSpeed.min;
    default:
      return Math.random() * (timing.maxDelay - timing.minDelay) + timing.minDelay;
  }
}
